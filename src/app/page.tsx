...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#FDFCFB] text-[#2C2C2C] selection:bg-[#1E3A8A]/10">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-16 px-6 py-24 lg:grid-cols-2 lg:px-12 lg:py-32 items-center">
          <div className="flex flex-col">
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <a
                href="tel:+33400000000"
                className="flex items-center justify-center gap-3 rounded-lg bg-[#fbbf24] px-7 py-4 text-xs font-bold uppercase tracking-widest text-[#121926] shadow-[0_10px_30px_-10px_rgba(251,191,36,0.5)] transition-all hover:translate-y-[-2px] hover:bg-[#fcd34d]"
              >
                Demander un devis
              </a>
              <a
                href="#reservation"
                className="flex items-center justify-center rounded-lg border border-white/20 bg-white/5 px-7 py-4 text-xs font-bold uppercase tracking-widest text-white backdrop-blur-sm transition-all hover:bg-white/10"
              >
                Réserver en ligne
              </a>
            </div>
            ...
            <div className="relative rounded-[2rem] border border-white/10 bg-white/5 p-8 backdrop-blur-xl transition-transform hover:scale-[1.02]">
              ...
              <div className="mt-8 flex items-center justify-between rounded-xl border border-white/5 bg-white/[0.05] p-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs font-medium sm:text-sm">Marseille & Secteur Adoume</span>
                </div>
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-12 lg:px-24">
          <div className="flex flex-col gap-8 border-l border-white/10 pl-8 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-[#fbbf24]">
                Ancrage Local
              </span>
      ...
      <section id="reservation" className="mx-auto max-w-7xl px-6 py-24 sm:px-12 lg:px-24 lg:py-32">
        <div className="grid gap-16 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="flex flex-col justify-center">
            ...
            <h2 className="mt-5 font-serif text-3xl leading-tight text-[#121926] sm:text-4xl">
              Planifiez votre rendez-vous
            </h2>
            <p className="mt-5 text-sm text-[#6E6E6E] sm:text-base">
            ...
            <div className="mt-10 space-y-8">
              <div className="grid gap-4 sm:grid-cols-3">
                {["Dépannage", "Installation", "Devis"].map((title) => (
                  <button
                    key={title}
                    className="flex flex-col items-center justify-center rounded-xl border border-[#E5E1DA] bg-white p-5 shadow-sm transition-all hover:border-[#fbbf24] hover:shadow-md"
                  >
          ...
          <form className="relative overflow-hidden rounded-[2.5rem] bg-[#121926] p-8 shadow-2xl sm:p-10">
            <div className="relative z-10">
              ...
              <p className="mt-2 text-xs text-[#8C8C8C] sm:text-sm">Indiquez vos besoins, Antoine vous recontacte.</p>
              <div className="mt-8 space-y-4">
                <input className="w-full rounded-lg border border-white/10 bg-white/5 px-5 py-4 text-sm text-white outline-none placeholder:text-[#6E6E6E]" placeholder="Nom complet" />
                <input className="w-full rounded-lg border border-white/10 bg-white/5 px-5 py-4 text-sm text-white outline-none placeholder:text-[#6E6E6E]" placeholder="Téléphone" />
                <input className="w-full rounded-lg border border-white/10 bg-white/5 px-5 py-4 text-sm text-white outline-none placeholder:text-[#6E6E6E]" placeholder="Date souhaitée" />
                <textarea className="min-h-32 w-full rounded-lg border border-white/10 bg-white/5 px-5 py-4 text-sm text-white outline-none placeholder:text-[#6E6E6E]" placeholder="Détaillez votre demande" />
              </div>
              <button className="mt-6 w-full rounded-lg bg-[#fbbf24] px-6 py-4 text-xs font-bold uppercase tracking-widest text-[#121926] transition-all hover:bg-[#fcd34d]">
      ...
      <footer className="border-t border-[#E5E1DA] bg-white">
        <div className="mx-auto max-w-7xl px-6 py-10 text-center sm:px-12">
          <p className="text-xs uppercase tracking-[0.3em] text-[#8C8C8C]">Antoine Electric Marseille · Rue d’Adoume</p>
          <p className="mt-3 text-sm text-[#6E6E6E]">
            Dépannage, installation, mise aux normes et réservation en ligne.
          </p>
        </div>
      </footer>
    </main>
